...
var WorkerValidator = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3: return [4 /*yield*/, schema.isValid(req.body)];
                    case 4:
                    ...
                    case 5:
                        validation = _a.sent();
                        return [2 /*return*/, res.status(401).json(userView_1.UserView.manyErrors(validation))];
                    case 6:
