...
var ServiceValidator = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        validation = _a.sent();
                        return [2 /*return*/, res.status(401).json(serviceView_1.ServiceView.manyErrors(validation))];
                    case 3:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        if (!req.body.categoryId) return [3 /*break*/, 6];
                        categoryRepository = (0, typeorm_1.getCustomRepository)(CategoryRepository_1.CategoryRepository);
                        return [4 /*yield*/, categoryRepository.findOne({
                                id: req.body.categoryId,
                            })];
