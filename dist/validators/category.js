...
var CategoryValidator = /** @class */ (function () {
    ...
    CategoryValidator.prototype.create = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var schema, validation, categoryRepository, category;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        validation = _a.sent();
                        return [2 /*return*/, res.status(401).json(categoryView_1.CategoryView.manyErrors(validation))];
                    case 3:
                        categoryRepository = (0, typeorm_1.getCustomRepository)(CategoryRepository_1.CategoryRepository);
                        return [4 /*yield*/, categoryRepository.findOne({ name: req.body.name })];
                    case 4:
                        category = _a.sent();
                        if (category) {
                            return [2 /*return*/, res
    ...
    CategoryValidator.prototype.update = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var schema, validation, categoryRepository, category;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        categoryRepository = (0, typeorm_1.getCustomRepository)(CategoryRepository_1.CategoryRepository);
                        return [4 /*yield*/, categoryRepository.findOne({ id: req.params.id })];
                    case 4:
                        category = _a.sent();
                        if (!category) {
                            return [2 /*return*/, res
    ...
    CategoryValidator.prototype.delete = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var schema, validation, categoryRepository, category;
            return __generator(this, function (_a) {
                switch (_a.label) {
