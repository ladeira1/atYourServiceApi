            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!workerId) return [3 /*break*/, 2];
                        workerRepository = (0, typeorm_1.getCustomRepository)(WorkerRepository_1.WorkerRepository);
                        return [4 /*yield*/, workerRepository.findOne({ id: String(workerId) })];
                    case 1:
                        worker = _b.sent();
                        if (!worker)
                            return [2 /*return*/, res.status(200).json(serviceView_1.ServiceView.returnMany([]))];
                        filter = __assign(__assign({}, filter), { worker: worker });
                        _b.label = 2;
                    case 2: return [4 /*yield*/, serviceRepository.find({
                            where: filter,
                        })];
                    case 3:
                        services = _b.sent();
                        return [2 /*return*/, res.status(200).json(serviceView_1.ServiceView.returnMany(services))];
                    case 4:
                        err_1 = _b.sent();
                        return [2 /*return*/, res.status(401).json(serviceView_1.ServiceView.manyErrors(err_1))];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        id = req.params.id;
                        serviceRepository = (0, typeorm_1.getCustomRepository)(ServiceRepository_1.ServiceRepository);
                        return [4 /*yield*/, serviceRepository.findOne({ id: id })];
                    case 1:
                        service = _a.sent();
                        if (!service) {
                            return [2 /*return*/, res
                        ...
                        return [2 /*return*/, res.status(200).json(serviceView_1.ServiceView.returnService(service))];
                    case 2:
                        err_2 = _a.sent();
                        return [2 /*return*/, res.status(401).json(serviceView_1.ServiceView.manyErrors(err_2))];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, categoryRepository.findOne({ id: categoryId })];
                    case 2:
                        category = _b.sent();
                        serviceRepository = (0, typeorm_1.getCustomRepository)(ServiceRepository_1.ServiceRepository);
                        ...
                        images = [];
                        if (!(files && Array.isArray(files))) return [3 /*break*/, 7];
                        i = 0;
                        _b.label = 3;
                    case 3:
                        if (!(i < files.length)) return [3 /*break*/, 7];
                        file = files[i];
                        return [4 /*yield*/, (0, imgbb_uploader_1.default)(process.env.IMGBB_API_KEY, file.path)];
                    case 4:
                        response = _b.sent();
                    ...
                    case 8:
                        _b.sent();
                        return [2 /*return*/, res.status(201).json(serviceView_1.ServiceView.returnService(service))];
                    case 9:
                        err_3 = _b.sent();
                        return [2 /*return*/, res.status(401).json(serviceView_1.ServiceView.manyErrors(err_3))];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        workerRepository = (0, typeorm_1.getCustomRepository)(WorkerRepository_1.WorkerRepository);
                        return [4 /*yield*/, workerRepository.findOne({
                                id: userId,
                            })];
                    case 1:
                        worker = _a.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, serviceRepository.remove(service)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/, res.status(204).send()];
                    case 4:
                        err_4 = _a.sent();
                        return [2 /*return*/, res.status(401).json(serviceView_1.ServiceView.manyErrors(err_4))];
                    case 5: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        imageRepository = (0, typeorm_1.getCustomRepository)(ImageRepository_1.ImageRepository);
                        images = [];
                        if (!(files && Array.isArray(files))) return [3 /*break*/, 8];
                        i = 0;
                        _b.label = 4;
                    case 4:
                    ...
                    case 10:
                        err_5 = _b.sent();
                        return [2 /*return*/, res.status(401).json(serviceView_1.ServiceView.manyErrors(err_5))];
