...
export let ServiceRepository: {
    new (): {
        ...
        update(criteria: string | number | string[] | number[] | Date | typeorm_1.ObjectID | Date[] | typeorm_1.ObjectID[] | typeorm_1.FindConditions<any>, partialEntity: import("typeorm/query-builder/QueryPartialEntity").QueryDeepPartialEntity<any>): Promise<typeorm_1.UpdateResult>;
        delete(criteria: string | number | string[] | number[] | Date | typeorm_1.ObjectID | Date[] | typeorm_1.ObjectID[] | typeorm_1.FindConditions<any>): Promise<typeorm_1.DeleteResult>;
        softDelete(criteria: string | number | string[] | number[] | Date | typeorm_1.ObjectID | Date[] | typeorm_1.ObjectID[] | typeorm_1.FindConditions<any>): Promise<typeorm_1.UpdateResult>;
        restore(criteria: string | number | string[] | number[] | Date | typeorm_1.ObjectID | Date[] | typeorm_1.ObjectID[] | typeorm_1.FindConditions<any>): Promise<typeorm_1.UpdateResult>;
