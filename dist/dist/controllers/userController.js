            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4, workerController.find(user.id)];
                    case 2:
                        worker = _b.sent();
                        if (worker) {
                            worker.user = user;
                            return [2, res.status(200).json(workerView_1.WorkerView.returnWorker(worker))];
                        }
                        return [2, res.status(200).json(userView_1.UserView.returnUser(user, false))];
                    case 3:
                        err_1 = _b.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [2, res.status(200).json(userView_1.UserView.returnUser(user))];
                    case 3:
                        err_3 = _b.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!worker)
                            return [3, 3];
                        return [4, workerRepository.remove(worker)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [4, userRepository.findOne({ id: userId })];
                    case 4:
                        user = _a.sent();
                        return [4, userRepository.remove(user)];
                    case 5:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        return [2, res.status(400).json(userView_1.UserView.manyErrors(err_5.message))];
                    case 4: return [2];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        err_6 = _b.sent();
                        return [2, res.status(400).json(userView_1.UserView.manyErrors(err_6.message))];
                    case 4: return [2];
                }
            });
        });
