        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        validation = _a.sent();
                        return [2, res.status(401).json(categoryView_1.CategoryView.manyErrors(validation))];
                    case 3:
                        categoryRepository = (0, typeorm_1.getCustomRepository)(CategoryRepository_1.CategoryRepository);
                        return [4, categoryRepository.findOne({ name: req.body.name })];
                    case 4:
                        category = _a.sent();
                        if (category) {
                            return [2, res
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        categoryRepository = (0, typeorm_1.getCustomRepository)(CategoryRepository_1.CategoryRepository);
                        return [4, categoryRepository.findOne({ id: req.params.id })];
                    case 4:
                        category = _a.sent();
                        if (!category) {
                            return [2, res
