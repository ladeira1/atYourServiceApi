            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        worker = _a.sent();
                        if (!worker) {
                            return [2, res.status(404).json(offerView_1.OfferView.manyErrors(worker_1.WorkerErrors.NOT_FOUND))];
                        }
                        next();
                        return [2];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, userRepository.findOne({ id: req.userId })];
                    case 1:
                        user = _a.sent();
                        if (!user) {
                            return [2, res
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        validation = _b.sent();
                        return [2, res.status(401).json(offerView_1.OfferView.manyErrors(validation))];
                    case 3:
                        workerRepository = (0, typeorm_1.getCustomRepository)(WorkerRepository_1.WorkerRepository);
                        return [4, workerRepository.findOne({ id: req.userId })];
                    case 4:
                    ...
                    case 6:
                        ...
                        return [4, offerRepository.findOne({
                                service: service,
                                user: user,
                            })];
                    case 7:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, schema.isValid(__assign(__assign({}, req.body), req.params))];
                    case 1:
                        if (!!(_a.sent()))
                            return [3, 3];
                        return [4, schema
