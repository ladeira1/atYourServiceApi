            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, offerRepository.findOne({ id: id })];
                    case 1:
                        offer = _a.sent();
                        if (!offer)
                            return [2, res.status(200).json([])];
                        return [2, res.status(200).json(offerView_1.OfferView.returnOffer(offer))];
                    case 2:
                        err_1 = _a.sent();
                        return [2, res.status(401).json(offerView_1.OfferView.manyErrors(err_1))];
                    case 3: return [2];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, workerRepository.findOne({ id: userId })];
                    case 1:
                        worker = _a.sent();
                        serviceRepository = (0, typeorm_1.getCustomRepository)(ServiceRepository_1.ServiceRepository);
                        return [4, serviceRepository.find({ where: { worker: worker } })];
                    case 2:
                        services = _a.sent();
                        offers = [];
                        offerRepository = (0, typeorm_1.getCustomRepository)(OfferRepository_1.OfferRepository);
                        ...
                        _a.label = 3;
                    case 3:
                        if (!(i < (services === null || services === void 0 ? void 0 : services.length)))
                            return [3, 6];
                        return [4, offerRepository.find({
                    ...
                    case 5:
                        i++;
                        return [3, 3];
                    case 6: return [2, res.status(200).json(offerView_1.OfferView.returnMany(offers))];
                    case 7:
                        err_2 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, userRepository.findOne({ id: userId })];
                    case 1:
                        user = _a.sent();
                        offerRepository = (0, typeorm_1.getCustomRepository)(OfferRepository_1.OfferRepository);
                        return [4, offerRepository.find({ user: user })];
                    case 2:
                        offers = _a.sent();
                        return [2, res.status(200).json(offerView_1.OfferView.returnMany(offers))];
                    case 3:
                        err_3 = _a.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        serviceRepository = (0, typeorm_1.getCustomRepository)(ServiceRepository_1.ServiceRepository);
                        return [4, serviceRepository.findOne({ id: serviceId })];
                    case 1:
                        service = _b.sent();
                        userRepository = (0, typeorm_1.getCustomRepository)(UserRepository_1.UserRepository);
                        return [4, userRepository.findOne({ id: userId })];
                    case 2:
                        ...
                        return [4, offerRepository.save(offer)];
                    case 3:
                        _b.sent();
                        return [2, res.status(201).json(offerView_1.OfferView.returnOffer(offer))];
                    case 4:
                        err_4 = _b.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        offer = _a.sent();
                        return [4, offerRepository.remove(offer)];
                    case 2:
                        _a.sent();
                        return [2, res.status(204).send()];
                    case 3:
                        err_5 = _a.sent();
                        return [2, res.status(401).json(offerView_1.OfferView.manyErrors(err_5))];
                    case 4: return [2];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        offerRepository = (0, typeorm_1.getCustomRepository)(OfferRepository_1.OfferRepository);
                        return [4, offerRepository.findOne({ where: { id: id } })];
                    case 1:
                        offer = _a.sent();
                    ...
                    case 6:
                        err_6 = _a.sent();
                        return [2, res.status(401).json(offerView_1.OfferView.manyErrors(err_6))];
                    case 7: return [2];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_7 = _a.sent();
                        return [2, res.status(401).json(offerView_1.OfferView.manyErrors(err_7))];
                    case 4: return [2];
                }
            });
        });
